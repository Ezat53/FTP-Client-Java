...
<head>
    ...
    <title>500 - Sunucu Hatası - Xfer</title>
    ...
    <div class="container text-center">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                ...
                <h2 class="h3 mb-4">Sunucu Hatası</h2>
                <p class="lead text-muted mb-4">Sunucuda bir hata oluştu. Lütfen daha sonra tekrar deneyin.</p>
